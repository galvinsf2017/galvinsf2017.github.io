...
function(e) {
	...
	return function e(a, r, o) {
		...
		3: [function(e, a) {
			a.exports = {
				common: {
					name: "密码很通俗：您的密码是第 {{ value }} 个最常用的密码！",
					message: "您的密码过于通俗，很快就会被破解！"
				},
				xkcd: {
					name: "xkcd",
				...
				possiblyWord: {
					name: "可能是一个单词...",
					message: "您的密码看起来好像是一个单词。这样，您的密码将会被很快地破解，将个人信息包含在密码中会使您的密码很不安全"
				},
				onlyNumbers: {
					name: "字符多样化：只有数字的密码",
					message: "您的密码只包含数字，这将造成您的密码被轻易地穷举出来"
				},
				wordAndNumber: {
					name: "字符多样化：不安全的多样化",
					message: "您的密码看起来只有些许单词和一些数字，这将造成您的密码非常容易被破解"
				},
				lengthShort: {
					name: "密码长度：较短",
					message: "您的密码较短，一个长一些的密码将会更加安全"
				},
				justLetters: {
					name: "字符多样化：只有字母",
				...
				telephone: {
					name: "可能是一个电话号码或日期",
					message: "您的密码看起来好像包含电话号码或日期信息，将个人信息包含在密码中会使您的密码很不安全"
				},
				repeatedPattern: {
					name: "重复字符",
					message: "重复的字符将使您的密码更容易被猜测"
				},
				nonStandardCharacters: {
					name: "字符多样化：非常规字符",
					message: "您的密码包含非常规字符。这将使您的密码更加安全哦！"
				},
				lengthLong: {
					name: "密码长度：长",
