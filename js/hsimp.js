	...
	return function e(a, r, o) {
		...
		3: [function(e, a) {
			a.exports = {
				...
				possiblyWord: {
					name: "- 可能是一个单词...",
					message: "  您的密码看起来好像是一个单词，这将造成您的密码比较容易被破解；并且，将个人信息包含在密码中会使您的密码比较容易被破解"
				},
				onlyNumbers: {
					name: "- 用更复杂的字符：仅包含数字",
					message: "  您的密码仅包含数字，这将造成您的密码被非常轻易地穷举出来"
				},
				wordAndNumber: {
					name: "- 用更复杂的字符：仅是简单组合",
				...
				lengthShort: {
					name: "- 密码长度：较短",
					message: "  您的密码较短，一个长些的密码将会更加安全"
				},
				justLetters: {
					name: "- 用更复杂的字符：仅包含字母",
					message: "  您的密码仅包含字母，在其中添加数字与特殊符号将使您的密码更加安全"
				},
				noSymbols: {
					name: "- 用更复杂的字符：缺少特殊符号",
